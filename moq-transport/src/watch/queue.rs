...
/// The queue was closed before a pushed item could be confirmed popped.
#[derive(Debug, Clone, Copy, PartialEq, Eq, thiserror::Error)]
#[error("queue closed before the item was popped")]
...
impl<T> Queue<T> {
    ...
    /// Returns Err(QueueClosed) if the queue was closed before the item could be confirmed popped.
