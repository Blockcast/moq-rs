...
type AcceptedSession = (web_transport::Session, ConnInfo);
...
pub struct ConnInfo {
    ...
    /// Exact MoQT wire profile selected during ALPN or WebTransport subprotocol negotiation.
    pub selected_version: WireProfile,
